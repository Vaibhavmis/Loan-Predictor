...
#run command in terminal - streamlit run loan.py
...
cibil=st.sidebar.number_input("🧾CBIL Score:", min_value=300, max_value=900, value=700, step=50)
loan=st.sidebar.number_input("💰Loan Amount:",min_value=50000,max_value=1000000,value=200000,step=5000)
...
st.markdown("---")
st.caption("Mini Project | Loan Approval Prediction | Decision Tree Classifiers")